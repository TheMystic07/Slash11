...
namespace DevelopersHub.RealtimeNetworking.Server
{
    public static class Data
    {
        ...
        // SOL constants
        public static readonly long lamportsPerSol = 1000000000; // 1 SOL = 1,000,000,000 lamports
        
        public static readonly long updatePeriod = 1;
        ...
        public class Player
        {
            ...
            public string walletAddress = ""; // New property for wallet address
            public double balanceSol = 0; // New property for SOL balance
            public long balanceLamports = 0; // New property for lamports (SOL's smallest unit)
            public List<Building> buildings = new List<Building>();
