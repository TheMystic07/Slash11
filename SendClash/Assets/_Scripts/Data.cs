namespace DevelopersHub.ClashOfWhatecer
{
    ...
    public static class Data
    {
        ...
        public const long lamportsPerSol = 1000000000; // 1 SOL = 1 billion lamports
        ...
        public class Player
        {
            ...
            public string walletAddress = ""; // Added wallet address for Solana
            public double balanceSol = 0; // SOL balance (float)
            public long balanceLamports = 0; // Lamports (integer - 1 SOL = 1 billion lamports)
            public List<Building> buildings = new List<Building>();
        ...
        {
            // Battle search cost in SOL (converted to lamports)
            // Range: 0.001 to 0.1 SOL
            switch (townHallLevel)
            {
                case 1: return 1000000; // 0.001 SOL
                case 2: return 2000000; // 0.002 SOL
                case 3: return 5000000; // 0.005 SOL
                case 4: return 10000000; // 0.01 SOL
                case 5: return 20000000; // 0.02 SOL
                case 6: return 38000000; // 0.038 SOL
                case 7: return 42000000; // 0.042 SOL
                case 8: return 58000000; // 0.058 SOL
                case 9: return 85000000; // 0.085 SOL
                case 10: return 100000000; // 0.1 SOL
                case 11: return 100000000; // 0.1 SOL
                case 12: return 100000000; // 0.1 SOL
                case 13: return 100000000; // 0.1 SOL
                case 14: return 100000000; // 0.1 SOL
                case 15: return 100000000; // 0.1 SOL
                default: return 100000000; // 0.1 SOL
            }
        }
